  ...
  const info = await transporter.sendMail({
    ...
    html: `
      ...
      <html>
        ...
        <body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#FFF8F8;margin:0;padding:40px 20px;">
          <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:16px;padding:32px;box-shadow:0 4px 24px rgba(244,114,182,.1);">
            ...
            <div style="text-align:center;padding-top:12px;">
              <p style="margin:0;color:#F472B6;font-size:16px;font-weight:600;">
                💕 Time to make this promise come true! 💕
              </p>
            </div>
